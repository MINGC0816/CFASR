# Dual-domain divide-and-conquer for scene text image super-resolution (CFASR)

This repository contains the source code for the Knowledge-Based Systems paper "Dual-domain divide-and-conquer for scene text image super-resolution", [access link](https://www.sciencedirect.com/science/article/pii/S0950705125017241?via%3Dihub=).
...
![Visualization results](fig/table.png)
...
```
git clone https://github.com/MINGC0816/CFASR.git
cd CFASR
conda env create -f environment.yml
conda activate cfasr
```
...
```
CUDA_VISIBLE_DEVICES=0 python main.py --arch="cfasr" --test_model="CRNN" --batch_size=46 --STN  --sr_share --gradient  --use_distill --stu_iter=1 --vis_dir='test' --mask --triple_clues --text_focus --lca
```
...
```
CUDA_VISIBLE_DEVICES=1 python main.py --arch="cfasr" --test_model="CRNN" --batch_size=46  --STN  --sr_share --gradient  --use_distill --stu_iter=1 --vis_dir='vis/test' --mask --go_test --resume='ckpt/c3stisr-all-warmup-2ratio' --triple_clues --text_focus --lca --vis
```
...
```
CUDA_VISIBLE_DEVICES=0 python3 main.py --arch="cfasr" --test_model="CRNN" --batch_size=28 --STN   --gradient  --use_distill --stu_iter=3 --vis_dir='xxx' --mask --triple_clues --text_focus --lca
```
...
```
CUDA_VISIBLE_DEVICES=0  python3 main.py --arch="cfasr" --test_model="CRNN" --batch_size=28 --STN  --gradient  --use_distill --stu_iter=3 --vis --vis_dir='vis/xxx' --mask --go_test --resume='ckpt/xxx/' --triple_clues --text_focus --lca
```
