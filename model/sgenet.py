...
from model.Position_aware_module import Visual_Semantic_Alignment
from tps_spatial_transformer import TPSSpatialTransformer
from stn_head import STNHead
from torchvision import transforms
from model.PaddleOCR2Pytorch.load_svtrnet import load_svtrnet
SHUT_BN = False
...
class SGENet(nn.Module):
    def __init__(self,
        ...
        self.position_prior = load_svtrnet(self.parser)
        self.guidanceGen = Visual_Semantic_Alignment(cfg.PositionAware)
    ...
    def forward(self, x):
        ...
        pos_prior = {}
        attn_map, text_logits = self.position_prior(x_) # text_logits.size: [1, 25, 37]
        pos_prior['attn_map'] = attn_map
        pos_prior['text_logits'] = text_logits
...
if __name__ == "__main__":
    ...
    x = torch.randn(1, 3, 32, 128).to(device)  # 输入大小 = (batch, channel, height, width)
