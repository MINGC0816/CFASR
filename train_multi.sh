CUDA_VISIBLE_DEVICES=0 python main.py --arch="cfasr" --test_model="CRNN" --batch_size=48 --STN  --gradient  --use_distill --stu_iter=3 --vis_dir='test' --mask --triple_clues --text_focus --lca
