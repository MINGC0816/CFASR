...
ABLATION_SET = ["tsrn_tl_cascade", "srcnn_tl", "srresnet_tl", "rdn_tl", "vdsr_tl",'cfasr']
...
class TextSR(base.TextBase):
    ...
    def test(self):
        ...
        if self.args.rec == 'moran':
            ...
            abinet = self.ABINet_init()
            abinet.eval()
        elif self.args.rec == 'matrn':
            matrn = self.MATRN_init()
            matrn.eval()
        elif self.args.rec == 'parseq':
            parseq = self.PARSeq_init()
            parseq.eval()
