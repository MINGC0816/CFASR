...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='cfasr', choices=['tsrn_tl_cascade_sft', 'tsrn', 'bicubic', 'srcnn', 'vdsr', 'srres', 'esrgan', 'scgan', 'rdn', 'tbsrn',
                                                           'edsr', 'lapsrn', 'tsrn_tl_wmask', 'tsrn_tl_cascade', 'srcnn_tl', 'srresnet_tl', 'rdn_tl', 'vdsr_tl', 'tranSR_v4',
                                                                    "esrgan_tl", "scgan_tl", 'tbsrn_tl', 'tatt', "han", 'pcan', 'pcan_tl','TSRN_TL','C3-STISR','rtsrn','cfasr'])
